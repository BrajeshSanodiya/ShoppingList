...
import 'package:grocery_snap/data/dummy_items.dart';
...
class _GroceryListState extends State<GroceryList> {
  ...
  void callAddButton() async{
     final newItem= await Navigator.of(context).push(MaterialPageRoute(builder: (ctx)=> const AddGrocery()));
     if(newItem==null){
      return;
     }
     setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          actions: [
            IconButton(onPressed:callAddButton , icon: Icon(Icons.add))
          ],
          ),
          body: content,
    );
